...
export default function LightingStipulation({ fixtureData, electricRate }) {
  const fixtures = fixtureData || DEFAULT_FIXTURE_DATA;
  const rate = electricRate || 0.105;
  ...
  return (
    <div>
      ...
      <svg viewBox="0 0 600 100" style={{ width: "100%", maxWidth: 600, display: "block", margin: "0 auto 1rem" }}>
        ...
        <text x="150" y="90" textAnchor="middle" fontSize="10" fill="#e74c3c" fontWeight="600">T8 Fluorescent</text>
        ...
        <text x="450" y="90" textAnchor="middle" fontSize="10" fill="#27ae60" fontWeight="600">LED Panel</text>
      </svg>
      ...
      <div className="info-grid" style={{ marginTop: '1rem' }}>
        ...
        <div className="info-card">
          ...
          <p>${fmt(totals.kwhSaved * rate)} at ${rate.toFixed(3)}/kWh</p>
        </div>
        <div className="info-card">
